...
import static cn.ttzero.excel.entity.style.Styles.INDEX_NUMBER_FORMAT;
import static cn.ttzero.excel.entity.style.Styles.testCodeIsDate;
...
public class StylesTest {
    ...
    @Test public void testFastTestDateFmt() throws IOException {
        Path storagePath = WorkbookTest.getOutputTestPath().resolve("styles.xml");
